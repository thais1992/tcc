...
\citeonline{Pesquisa_Univali}, o resultado obtido neste tipo de pesquisa
...
% onde ocprincipal foco deste tipo de pesquisa é a geração de conhecimento, dentro de um
% curto espaço de tempo, propondo a aplicação prática da metodologia, tendo como
% foco um meio de resolver um problema ou uma necessidade de maneira única, cujo o
% problema tenha relação e participação com os ambientes locais e regionais.

% \par O tipo de pesquisa será qualitativa, para \citeonline{artigo_USP_Pesquisa},
% o método de pesquisa qualitativa presenta método focado em uma direção, durante o
% tempo de desenvolvimento; Este tipo de pesquisa não busca mensurar dados, o foco
% deste tipo de pesquisa é muito mais amplo e direcionado.

% Contexto da pesquisa

\section{Contexto da Pesquisa}

%Onde Vai ser aplicada a pesquisa
% \par Para realizar à pesquisa serão utilizados livros, manuais, tutoriais,
...
\citeonline{Pesquisa_Lakatos}, os instrumentos de pesquisa contêm “desde os
...
% Retirar o ICONIX e colocar um resumo sobre o procedimento de análise da rede,
% levantamento de dados de gerencia
